 ...
 * <p>
 * Both producer (idempotent, JSON serializer) and consumer (manual ack,
 * ErrorHandlingDeserializer, JSON deserializer) are wired with sensible
 * defaults. Services only need to inject the {@link KafkaTemplate} bean
 * or use {@link AbstractKafkaConsumer}.
 */
@Configuration
@EnableKafka
