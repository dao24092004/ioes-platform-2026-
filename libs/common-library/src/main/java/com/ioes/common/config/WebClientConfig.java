...
/**
 * Shared {@link WebClient} bean for inter-service REST calls.
 * <p>
 * Timeouts are tuned against the API Gateway default 30s. For longer
 * operations (e.g. AI inference) override per-client via
 * {@code WebClient.builder().clone()...}.
 */
@Configuration
