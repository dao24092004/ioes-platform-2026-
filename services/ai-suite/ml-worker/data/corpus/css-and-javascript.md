...
doc_id: css-and-javascript
source_url: https://developer.mozilla.org/en-US/docs/learn-web-development/core/accessibility/css-and-javascript
...
CSS and JavaScript, when used properly, also have the potential to allow for accessible web experiences, or they can significantly harm accessibility if misused. This article outlines some CSS and JavaScript best practices that should be considered to ensure even complex content is as accessible as possible.
      ...
      Learning outcomes:
          ...
          Accessible text sizing and layout.
          Color contrast.
          The importance of :focus and :hover styles.
          Sensible animation usage — use animation subtly and provide controls to turn it off.
          Best practices for hiding content so that it doesn't become inaccessible.
          That there is such a thing as too much JavaScript, and the value of unobtrusive JavaScript.
          Using events sensibly so you don't lock out specific control types.
...
On the other hand, you shouldn't use visibility", "visibility: hidden or display", "display: none, because they do hide content from screen readers. Unless of course, there is a good reason why you want this content to be hidden from screen readers.
