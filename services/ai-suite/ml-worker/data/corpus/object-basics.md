...
doc_id: object-basics
source_url: https://developer.mozilla.org/en-US/docs/learn-web-development/core/scripting/object-basics
...
Now open your browser's [JavaScript console](/en-US/docs/Learn_web_development/Howto/Tools_and_setup/What_are_browser_developer_tools#the_javascript_console), enter `person` into it, and press Enter/Return. You should get a result similar to one of the below lines:
