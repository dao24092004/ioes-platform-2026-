...
doc_id: mobile
source_url: https://developer.mozilla.org/en-US/docs/learn-web-development/core/accessibility/mobile
...
Using [viewport](/en-US/docs/Web/HTML/Reference/Elements/meta/name/viewport), it is possible to disable zoom. Always ensure resizing is enabled, and set the width to the device's width in the head:
