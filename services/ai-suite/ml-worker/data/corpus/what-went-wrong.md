...
doc_id: what-went-wrong
source_url: https://developer.mozilla.org/en-US/docs/learn-web-development/core/scripting/what-went-wrong
...
When you built up the "Guess the number" game in the previous article, you may have found that it didn't work. Never fear — this article aims to save you from tearing your hair out over such problems by providing you with some tips on how to find and fix errors in JavaScript programs.
      ...
      Prerequisites:
      An understanding of HTML and the fundamentals of CSS, basic experience with writing JavaScript.
      ...
      Learning outcomes:
          ...
          Basic familiarity with JavaScript error messages and their meanings.
...
6. At this point, we are trying to make the variable contain a reference to an element in the document's HTML. Let's see what the variable contains after this line runs. Add the following code on line 54:
   ...
   This code will print the value of `lowOrHi` to the console after we tried to set it in line 51. See  for more information.
...
10. Try saving and refreshing again, and your `console.log()` statement should return the `` element we want. Phew! Another error fixed! You can delete your `console.log()` line now, or keep it to reference later on — your choice.
