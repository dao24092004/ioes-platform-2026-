...
title: HTML images
doc_id: html-images
source_url: https://developer.mozilla.org/en-US/docs/learn-web-development/core/structuring-content/html-images
...
In the beginning, the web was just text, and it was really quite boring. Fortunately, it wasn't too long before the ability to embed images (and other more interesting types of content) inside web pages was added. In this article we'll look at how to use the img element in depth, including the basics, annotating it with captions using figure, and detailing how it relates to CSS background images.
      ...
      Learning outcomes:
          ...
          Using src to point to a resource.
          ...
          Understanding media asset licensing — different types of license, how to comply with them, and how to search for appropriately licensed media files to use in projects.
...
> [!NOTE]
> [HTML tags](https://scrimba.com/html-css-crash-course-c02l/~0d?via=mdn) [_MDN learning partner_](/en-US/docs/MDN/Writing_guidelines/Learning_content#partner_links_and_embeds) from Scrimba is an interactive lesson providing information on images, and mini-challenges.
...
2. Edit the existing img tag so that it embeds the image located at the following URL:
...
1. Click **"Play"** in the code block below to edit the example in the MDN Playground.
2. Wrap the `` element in a figure element.
3. Copy the text out of the `title` attribute, put it inside a figcaption element below the `` element, then remove the `title` attribute.
